---
name: list-theses
description: List business Theses, optionally filtered by Company or status, grouped so 'challenged' ones stand out. Use when the investor wants to see which hypotheses are maturing and which need review.
---

# 事業仮説一覧を閲覧する (List Theses)
...
5. 0件の場合は「登録済みの事業仮説はまだありません」と伝え、`create-thesis` skill での新規作成を提案する。
