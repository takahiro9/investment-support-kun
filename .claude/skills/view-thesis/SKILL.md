---
name: view-thesis
description: View a Thesis's full detail — invalidation/confirmation conditions, lifecycle status, its source Thoughts/Findings, and any linked Signals/Predictions. Use when the investor wants to reassess a hypothesis.
---
...
4. 成功時は stdout の JSON をもとに提示する:
   - `statement`、`invalidation`/`confirmation`（対で表示）、`horizon`/`probability`、論証本文
